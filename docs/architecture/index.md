...
From Zero RAG is a **single Nuxt 3 application**: Vue 3 on the client, **Nitro** (`h3`) server routes on the same port, **Prisma** + **PostgreSQL/pgvector** for persistence, and the **Vercel AI SDK** for embeddings, streaming chat, and tool execution.
