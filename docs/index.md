...
features:
  - title: Library
    ...
    details: Production patterns out of the box — hybrid search, MMR, durable ingest, eval harness. Pluggable backends.
  - title: Tutorial
    icon:
  ...
  - title: Portfolio
    ...
    details: Public benchmarks on a real corpus — hit-rate, MRR, faithfulness and cost per query, per release.
---
