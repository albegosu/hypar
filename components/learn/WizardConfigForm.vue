<template>
  <section v-if="fields.length > 0" class="wz-panel">
    ...
    <div class="p-5 space-y-4 text-sm">
      ...
      <!-- Advanced disclosure -->
      <div v-if="visibleAdvanced.length" class="mt-4 pt-4 border-t" style="border-color: var(--wz-accent-faint)">
        <button
          type="button"
        ...
        <div
          ...
          style="border-color: var(--wz-accent-faint)"
        >
