...
export function createChunksTable(): string {
  ...
  hints: [
    ...
    {
      id: 'hint-3-1-3',
      text: 'Check the actual schema in prisma/schema.prisma for reference',
      xpPenalty: 10,
      order: 3,
    },
  ],
...
## Real-World Example from the unified server utils
...
export function findSimilarChunks(
  ...
  hints: [
    ...
    {
      id: 'hint-3-3-3',
      text: 'Check server/utils/search.service.ts for reference implementation',
      xpPenalty: 20,
      order: 3,
    },
  ],
