...
export function chunkTextWithOverlap(
  ...
  hints: [
    ...
    {
      id: 'hint-2-2-3',
      text: 'Look at server/utils/chunking.ts for reference implementation',
      xpPenalty: 15,
      order: 3,
    },
  ],
